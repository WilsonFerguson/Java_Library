...
public class Inventory {
    ...
    public void addColumn() {
        Item[][] newItems = new Item[width + 1][height];
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
     ...
     */
    public void addRow() {
        Item[][] newItems = new Item[width][height + 1];
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                newItems[x][y] = items[x][y];
            }
    ...
    public void sort() {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                Item newItem = uniqueItems.get(index);
        ...
        Item[] sortedItems = new Item[finalItems.size() + uniqueItems.size()];
        ...
        while (true) {
            ...
            for (int i = 0; i < sortedItems.length - 1; i++) {
                ...
                Item secondItem = sortedItems[i + 1];
